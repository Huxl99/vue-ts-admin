<template>
  <el-card>
    ...
    <!-- table:---border:可以设置表格纵向是否有边框
            ...
            -->
    <el-table style="margin: 10px 0px" border :data="product.trademarkArr">
      <el-table-column
        label="#"
        width="80px"
        align="center"
      ...
      <el-table-column
        ...
        prop="tmName"
      ></el-table-column>
      <el-table-column :label="t('brand.brandLogo')">
        <template #="{ row, $index }">
          <img
            :src="row.logoUrl"
  ...
  <el-dialog
    ...
    :title="trademarkParams.id ? t('brand.updateBrand') : t('brand.addBrand')"
  >
    <el-form
      style="width: 80%"
...
//@ts-ignore
import { ElMessage, UploadProps, formEmits, ElMessageBox } from 'element-plus'
